function(add_kext_bundle name)
    cmake_parse_arguments(SL "KERNEL_PRIVATE" "MACOSX_VERSION_MIN;INFO_PLIST;BUNDLE_IDENTIFIER;BUNDLE_VERSION;MAIN_FUNCTION;ANTIMAIN_FUNCTION;ARCHS" "" ${ARGN})

    if(SL_MACOSX_VERSION_MIN)
        if (SL_ARCHS)
            add_darwin_shared_library(${name} MODULE MACOSX_VERSION_MIN ${SL_MACOSX_VERSION_MIN} ARCHS ${SL_ARCHS})
        else()
            add_darwin_shared_library(${name} MODULE MACOSX_VERSION_MIN ${SL_MACOSX_VERSION_MIN})
        endif()
    else()
        if (SL_ARCHS)
            add_darwin_shared_library(${name} MODULE ARCHS ${SL_ARCHS})
        else()
