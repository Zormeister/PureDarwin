...
#define DBG_IOG_AGC_MUTE                    50  // 0x32 0x53200C8: arg1 regID, arg2 newState, arg3 oldState0
//! Guess work based on the following
//! - When the KTRACE was introduced
//! - Where in the source code  its positioned (IE: if its from line 1400 and another is from 1200, the 1200 print gets higher priority
//! ASYNC_WORK - Origins: IOGraphics-530.66
#define DBG_IOG_ASYNC_WORK                  51  // 0x33 0x53200CC: arg1 regID, arg2 work, arg3 didWork
//! TIMELOCK - Origins: IOGraphics-558.3.1 - IOFramebuffer.cpp : Line  758
#define DBG_IOG_TIMELOCK                    52  // 0x34 0x53200D0: arg1 nameBufInt, arg2 fnBufInt[0], arg3 fnBufInt[1]
//! CURSORLOCK - Origins: IOGraphics-558.3.1 - IOFramebuffer.cpp : Line  1211
#define DBG_IOG_CURSORLOCK                    53  // 0x34 0x53200D0: arg1 nameBufInt, arg2 fnBufInt[0], arg3 fnBufInt[1], arg4 cursorThresholdAt
