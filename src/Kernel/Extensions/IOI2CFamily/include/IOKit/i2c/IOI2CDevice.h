...
protected:
	...
	*/
	...
	// fyi the IOPlatfomFunction methods got stripped, please do NOT use this IOI2CFamily port with the older kexts
	// i will find you and smite you if you do, warmest regards, zormeister
...
protected:
	...
	*/
protected:
    OSMetaClassDeclareReservedUnused ( IOI2CDevice,  0 ); // used to be a getPlatformFunction instance, removed because of the obvious
